...
if mode == "train":
    # Dataset address
    train_gt_images_dir = f"./data/T91"

    test_gt_images_dir = f"../../../fin_2/ESPCN-pytorch/data/Set5/GTmod12"
...
if mode == "test":
    ...
    gt_dir = "../../../fin_2/ESPCN-pytorch/data/Set5/GTmod12"

    model_weights_path = "../../../fin_2/ESPCN-pytorch/best.pth"